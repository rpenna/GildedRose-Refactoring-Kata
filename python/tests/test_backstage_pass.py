...
def test_given_a_long_term_sell_in_backstage_pass_when_update_quality_then_it_should_decresase_sell_in_by_1():
    backstage_pass = Item(BACKSTAGE_PASS, LONG_TERM_SELL_IN, DEFAULT_QUALITY)
    gilded_rose = GildedRose([backstage_pass])
    gilded_rose.update_quality()
...
def test_given_a_medium_term_sell_in_backstage_pass_when_update_quality_then_it_should_decresase_sell_in_by_1():
...
def test_given_a_short_term_sell_in_backstage_pass_when_update_quality_then_it_should_decresase_sell_in_by_1():
    backstage_pass = Item(BACKSTAGE_PASS, SHORT_TERM_SELL_IN, DEFAULT_QUALITY)
    gilded_rose = GildedRose([backstage_pass])
    gilded_rose.update_quality()
